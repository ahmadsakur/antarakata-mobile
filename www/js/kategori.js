      ...
      if ((xmlhttp.readyState == 4) && (xmlhttp.status == 200)) {
         ...
         if (isEmpty(post)) {
            ...
            for (x in post) {
               ...
               html += "</div>";
               html += "<div class=\"mb-2\"><button type=\"button\" onclick=\"window.location.href='detail.html?idpost=" + post[x].idpost + "';\" class=\"btn btn-warning tombol-detail\">Read More . .</button></div>";
